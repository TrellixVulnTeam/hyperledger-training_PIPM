...
function registerUser(username,org1mspid,orgPath){
	...
	var casereverRootsPath = "../crypto-config/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem"
	var data = fs.readFileSync(casereverRootsPath);
	...
	//make sure you add ca.org1.example.com in your /etc/host file and map it with localhost or your machine ip.
	//if you dont do so you might get an tls cn not found errror
	var cop = new COP("https://ca.org1.example.com:7054",tlsoptions);
	var client = new Client();
			...
			if (user && user.isEnrolled()) {
				...
				return user;
						...
						return cop.enroll({
									...
									member = new User("admin");
									member.setCryptoSuite(client.getCryptoSuite());
									return member.setEnrollment(enrollment.key, enrollment.certificate,org1mspid);
								...
								console.log('Failed to enroll and persist user. Error: ',err);
								return null;
						});
			}});
